...
function air(data) {
    ...
    //need to convert the pressure to gauge pressure
    pressureHigh = pressureHigh + P_ATMOSPHERE;
    ...
    while (pressureHigh > P_ATMOSPHERE) {
        ...
        //convert the pressure back to gauge pressure
        pressureLow = pressureLow - P_ATMOSPHERE;
        ...
        pressureHigh = pressureLow + P_ATMOSPHERE;
